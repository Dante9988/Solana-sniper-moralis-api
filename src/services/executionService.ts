...
export async function applyReceipt(
  ...
  const receiptData = {
    ...
    grossVenueOutput: r.grossVenueOutput === null ? null : new Prisma.Decimal(r.grossVenueOutput),
    netWalletOutput: r.netWalletOutput === null ? null : new Prisma.Decimal(r.netWalletOutput),
    hookFeeAmount: r.hookFeeAmount === null ? null : new Prisma.Decimal(r.hookFeeAmount),
